...
describe("ProviderCommandReactor", () => {
  ...
  it.each([
    { initialBranch: "t3code/1234abcd", settings: {}, expectedBranch: "t3code/fix-reconnect" },
    {
      initialBranch: "t3code/1234abcd",
      settings: { branchPrefix: "noah/" },
      expectedBranch: "noah/fix-reconnect",
    },
    {
      initialBranch: "noah/worktree-1234abcd",
      settings: { branchPrefix: "noah/" },
      expectedBranch: "noah/fix-reconnect",
    },
    {
      initialBranch: "previous/worktree-1234abcd",
      settings: {
        branchPrefix: "team/",
        projectSettingsOverrides: { "project-1": { branchPrefix: "noah/" } },
      },
      expectedBranch: "noah/fix-reconnect",
    },
    {
      initialBranch: "worktree-1234abcd",
      settings: { branchPrefix: "" },
      expectedBranch: "fix-reconnect",
    },
  ])(
    "generates $expectedBranch for the first turn",
    async ({ initialBranch, settings, expectedBranch }) => {
