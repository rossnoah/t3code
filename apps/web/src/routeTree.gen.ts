...
import { Route as SettingsReposRouteImport } from './routes/settings.repos'
...
const SettingsReposRoute = SettingsReposRouteImport.update({
  id: '/repos',
  path: '/repos',
  getParentRoute: () => SettingsRoute,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/settings/repos': typeof SettingsReposRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/settings/repos': {
      ...
      preLoaderRoute: typeof SettingsReposRouteImport
      parentRoute: typeof SettingsRoute
    }
    '/settings/providers': {
...
interface SettingsRouteChildren {
  ...
  SettingsReposRoute: typeof SettingsReposRoute
...
const SettingsRouteChildren: SettingsRouteChildren = {
  ...
  SettingsReposRoute: SettingsReposRoute,
